    ...
    def init_population(self):
        ...
        for i in range(self.part_num):
            ...
            for j in range(len(x.Pos)):
                x.Pos[j] = np.random.uniform(self.var_size[j][0], self.var_size[j][1])#gaixiu
    ...
    def iterator(self):
        ...
        for i in range(self.num_itr):
            for j in range(self.part_num):
                # create r1,r2
                r1 = np.random.uniform(self.vmin, self.vmax, self.dim)#uniform
            ...
            #print_params(self.GlobalBest_Pos)
            print("Best Parameters: ","\nC=",  self.GlobalBest_Pos[0],"gamma:",  self.GlobalBest_Pos[1])
