...
def xml_txt(train_txt_path, train_image_path, val_txt_path, val_image_path, xml_dir_path, xml_dir, labels):
    train_cnt = 0
    val_cnt = 0
    ...
    for (root, dirname, files) in os.walk(xml_dir_path):
        ...
        for ft in files_train:
            ...
            # xml文件路径
            xml_path = os.path.join(xml_dir, fxml)
...
if __name__ == '__main__':
    ...
    train_image_path = "./datasets/images/train"
    val_txt_path = "./datasets/labels/val"
    val_image_path = "./datasets/images/val"

    xml_image_path = "./datasets/train/Japan/images"  # 存放图片和xml 的文件目录
    xml_dir = "./datasets/train/Japan/xmls"

    labels = ['D00', 'D10', 'D20', 'D40']  # 用于获取label位置
    xml_txt(train_txt_path, train_image_path, val_txt_path, val_image_path, xml_image_path,xml_dir, labels)
